...
const Description: FC<IDescriptionProps> = ({groupInfo}) => {
    ...
    return (
        <Container className='description-container'>
            <h1 className='description-container__group-name main-text'>СТОРОННІМ В</h1>
            <div className='description-div'>
                {/*TODO*/}
                {/*<p className='description-div__description secondary-text'>{groupInfo.description}</p>*/}
                <p className='description-div__description secondary-text'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor,
